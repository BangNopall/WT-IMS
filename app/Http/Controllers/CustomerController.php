...
class CustomerController extends Controller
{
    ...
    {   
        ...
        return response()->json([
            ...
            'anggota' => $anggota, // Optional: If you want to return the created product
        ]);
        ...
        //     'steamhex' => $request->input('steamhex'),
        // ]);
    ...
    public function update(Request $request, $id)
    {
        $this->validate($request, [
            ...
            'posisi'    => 'required|string|min:2',
            'steamhex'   => 'required|string|min:2',
        ]);
    ...
    public function ImportExcel(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            return redirect()->back()->with(['success' => 'Upload file data anggota !']);
        }
    ...
    {
        return (new ExportCustomers)->download('anggota.xlsx');
    }
}
